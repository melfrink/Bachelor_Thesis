...
# Step 1: Preprocess using PCA (set n_comp manually, more is more detailed, therefore also more likely to introduce noise)
...
hmp.visu.plot_topo_timecourse(epoch_data, 
                              estimates, 
                              info, 
                              as_time=True, 
                              event_lines=False, 
                              title="A. Topographical Timecourse",
                              vmin = -1e-5, 
                              vmax = 1e-5)
